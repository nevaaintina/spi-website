  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-800 font-sans overflow-x-hidden">
      ...
      {/* =========================================================
          HERO
      ========================================================= */}
      <section className="relative bg-[#0b2348] overflow-hidden">
        <div className="absolute -top-32 -right-32 w-96 h-96 rounded-full border border-white/10" />
        <div className="absolute top-20 right-20 w-40 h-40 rounded-full border border-[#ffc107]/20" />

        <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-16 py-20 md:py-28">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            
            <div className="relative z-10">
              <div className="inline-flex items-center gap-3 mb-6">
                <span className="w-10 h-[2px] bg-[#ffc107]" />
                <span className="text-[11px] font-bold tracking-[0.25em] text-[#ffc107] uppercase">
                  Career at SPI
                </span>
              </div>

              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black leading-[1.05] text-white tracking-tight">
                Build Your
                <br />
                <span className="text-[#ffc107]">Future With Us.</span>
              </h1>

              <p className="mt-7 max-w-xl text-sm md:text-base leading-7 text-slate-300">
              ...
              <div className="flex flex-wrap gap-4 mt-9">
                <a
                  href="#vacancies"
                  className="inline-flex items-center gap-3 px-6 py-3.5 bg-[#ffc107] text-[#0b2348] rounded-xl font-bold text-sm hover:bg-white transition-all duration-300"
                >
                  Lihat Lowongan
                  <span>→</span>
                </a>
                ...
                <a
                  href="#culture"
                  className="inline-flex items-center gap-3 px-6 py-3.5 border border-white/20 text-white rounded-xl font-semibold text-sm hover:bg-white/10 transition-all duration-300"
                >
                  Our Culture
                </a>
              </div>
            ...
            <div className="relative">
              <div className="absolute -inset-4 border border-[#ffc107]/20 rounded-[2rem] rotate-2" />
              ...
              <div className="relative h-[400px] md:h-[500px] rounded-[2rem] overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#0b2348]/80 via-transparent to-transparent" />

                <div className="absolute bottom-6 left-6 right-6">
                  <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl p-5">
                    <p className="text-[#ffc107] text-[10px] font-bold uppercase tracking-widest mb-1">
                      Join Our Team
                    </p>
      ...
      {/* =========================================================
          OUR CULTURE
      ========================================================= */}
      <section id="culture" className="relative bg-white py-20 md:py-24 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.95fr_1.55fr] gap-10 lg:gap-14">
            ...
            <div className="relative min-h-[620px] flex flex-col">
              ...
              <div className="absolute left-[-48px] right-[-30px] bottom-[-55px] h-[320px] pointer-events-none overflow-hidden">
                <img
                  src="https://images.unsplash.com/photo-1578662996442-48f60103fc96?auto=format&fit=crop&w=1200&q=85"
          ...
          <div className="mt-8 relative overflow-hidden rounded-3xl bg-[#0b2348] p-8 md:p-10 shadow-xl">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-5">
                <div className="w-14 h-14 rounded-2xl bg-[#ffc107]/20 border border-[#ffc107]/40 flex items-center justify-center text-[#ffc107] text-xl font-bold shrink-0">
                  SPI
                </div>
                <div>
      ...
      {/* =========================================================
          EMPLOYEE STORIES (FOTO DIPERJELAS & BACKGROUND SAMAR)
      ========================================================= */}
      <section className="relative py-24 md:py-28 bg-white overflow-hidden border-t border-b border-slate-200">
        
        {/* BACKGROUND FOTO PERTAMBANGAN SAMAR */}
        <div className="absolute inset-0 pointer-events-none">
          <img
            src="https://images.unsplash.com/photo-1578662996442-48f60103fc96?auto=format&fit=crop&w=1800&q=85"
            alt=""
            className="absolute right-0 top-0 w-[55%] h-full object-cover opacity-[0.08]"
          />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 xl:px-16">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="mt-3 text-3xl md:text-4xl font-black text-[#0b2348]">
              Hear From{" "}
              <span className="text-[#d89f00]">Our People.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-4xl mx-auto">
            {employeeStories.map((story, index) => (
              <div
                key={index}
                className="group relative bg-white border border-slate-200 rounded-2xl p-6 md:p-7 shadow-sm hover:shadow-lg hover:border-[#ffc107] transition-all duration-300"
              >
          ...
          <div className="flex justify-center mt-10">
            <div className="flex items-center gap-3 text-[9px] font-bold tracking-[0.2em] uppercase text-slate-300">
      ...
      <section className="py-20 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-16">
          <div className="relative min-h-[420px] md:min-h-[460px] overflow-hidden rounded-[2rem]">
            
            <img
              src="https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=1800&q=85"
              alt="Heavy Equipment Internship"
              className="absolute inset-0 w-full h-full object-cover"
            />

            <div className="absolute inset-0 bg-[#071d3b]/75" />
            <div className="absolute inset-0 bg-gradient-to-r from-[#071d3b]/95 via-[#071d3b]/70 to-transparent" />

            <div className="relative z-10 min-h-[420px] md:min-h-[460px] flex items-center">
              <div className="px-7 py-12 md:px-12 lg:px-16 max-w-2xl">
                
                <div className="flex items-center gap-3 mb-6">
                  <span className="w-8 h-[2px] bg-[#ffc107]" />
                  <span className="text-[10px] font-bold tracking-[0.22em] uppercase text-[#ffc107]">
                    Internship Program
                  </span>
                </div>

                <h2 className="text-3xl md:text-4xl lg:text-5xl font-black leading-[1.1] text-white">
                  Start Your Career
                  <br />
                  <span className="text-[#ffc107]">With Real Experience.</span>
                </h2>

                <p className="mt-6 text-sm md:text-[15px] text-slate-200 leading-7 max-w-xl">
                  Buka kesempatan bagi mahasiswa/i SMK atau Perguruan Tinggi
                  untuk merasakan pengalaman kerja nyata di industri alat berat
                  bersama para ahli dan profesional SPI.
                </p>

                <div className="mt-8">
                  <a
                    href="#apply"
                    className="inline-flex items-center gap-3 px-7 py-3.5 bg-[#ffc107] text-[#0b2348] rounded-xl text-xs font-black hover:bg-white transition-all duration-300"
                  >
                    Daftar Internship
                ...
                <div className="flex flex-wrap items-center gap-x-7 gap-y-3 mt-9 pt-6 border-t border-white/15">
                  <div className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-[#ffc107]" />
                    <span className="text-[10px] text-slate-300">Real Work Experience</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-[#ffc107]" />
                    <span className="text-[10px] text-slate-300">Professional Mentorship</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-[#ffc107]" />
                    <span className="text-[10px] text-slate-300">Career Development</span>
                  </div>
                </div>
            ...
            <div className="absolute hidden md:block right-10 bottom-8 text-[120px] lg:text-[160px] font-black text-white/[0.04] leading-none select-none">
              06
            </div>
