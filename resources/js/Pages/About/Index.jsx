...
const heroHighlights = [
  {
    icon: IconAward,
    title: "Authorized XCMG Partner",
    desc: "Official partner of XCMG",
  },
  {
    icon: IconEngineer,
  ...
  },
  {
    ...
    desc: "Coverage across Indonesia",
  },
  {
    icon: IconGenuine,
    title: "Genuine Spare Parts",
    desc: "100% original & quality assured",
  },
  {
    icon: IconClock,
    title: "24/7 Support",
    desc: "Always ready to support you",
  },
];
...
const companyProfile = [
  {
    icon: IconBuilding,
    label: "Company Name",
    value: "PT Servistama Pro Indonesia",
  },
  {
    icon: IconCalendar,
    label: "Established",
  ...
  },
  {
    icon: IconIndustry,
    label: "Industry",
    value: "Heavy Equipment Services",
  },
  {
    icon: IconFocus,
  ...
  },
  {
    ...
    value: "XCMG (Xuzhou Construction Machinery Group)",
  },
  {
    icon: IconMap,
    label: "Coverage Area",
...
const cultureItems = [
  ...
  },
  {
    ...
    desc: "We always strive to be better",
  },
  {
    icon: IconTarget2,
    title: "Customer Focus",
    desc: "Customer success is our mission",
  },
  {
    icon: IconBulb,
    title: "Innovation",
    desc: "We encourage new ideas and solutions",
  },
  {
    icon: IconRespect,
    title: "Respect",
    desc: "We value every individual",
  },
  {
    icon: IconCollab,
    title: "Collaboration",
...
const governancePrinciples = [
  {
    icon: IconEye,
    title: "Transparency",
    desc: "We conduct business with openness and honesty",
  },
  {
    icon: IconCheckBadge,
    title: "Accountability",
    desc: "We take responsibility for every decision and action",
  },
  {
    icon: IconShieldSafety,
    title: "Responsibility",
    desc: "We are responsible to stakeholders and the environment",
  },
  {
    icon: IconScale,
    title: "Fairness",
    desc: "We treat everyone fairly and equally",
  },
];
...
/* ------------------------------------------------------------------ */
/* Page                                                                 */
>>>>>>> 1093209413a61a42d61cbb0f4b67f37f427e4c41
/* ------------------------------------------------------------------ */
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:items-center lg:gap-14 lg:px-8">
          ...
          <div>
            ...
            <p className="mt-4 max-w-xl text-sm leading-relaxed text-[#64748B] md:text-base">
              Founded with a strong commitment to reliability and excellence,
              PT Servistama Pro Indonesia (SPI) provides integrated solutions
              in heavy equipment services, maintenance, spare parts, and
              technical support for mining, construction, and industrial
              sectors.
            </p>
...
<<<<<<< HEAD
      ...
      <section
        id="company-profile"
        className="bg-[#0F2B5C] py-16 md:py-20"
      >
            ...
            <ol className="relative space-y-6 border-l-2 border-[#E2E8F0] pl-6">
              {milestones.map((m, i) => (
                <li key={i} className="group relative">
                  <span className="absolute -left-[31px] top-0.5 flex h-4 w-4 items-center justify-center rounded-full border-2 border-[#0F2B5C] bg-white transition-colors duration-300 group-hover:border-[#FFC107] group-hover:bg-[#FFC107]" />

                  <p className="text-xs font-extrabold text-[#0F2B5C]">
                    {m.year}
                  </p>
...
=======
  {/* ============================== COMPANY CULTURE + GOVERNANCE ============================== */}
      {/* Menggunakan -mt-32 md:-mt-40 dan pt-0 agar menempel sempurna tanpa ruang kosong */}
      <section className="bg-[#F8FAFC] -mt-32 md:-mt-40 pt-0 pb-12">
...
>>>>>>> 1093209413a61a42d61cbb0f4b67f37f427e4c41
            <div className="rounded-2xl border border-[#E2E8F0] bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-[#FFC107] hover:shadow-xl md:p-7">
              <p className="mb-6 text-sm leading-relaxed text-[#64748B]">
                ...
                (GCG) principles in every aspect of our business.
              </p>
...
<<<<<<< HEAD
                    ...
                    >
                      <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#FFC107]/15 text-[#0F2B5C] transition-all duration-300 group-hover:scale-105 group-hover:bg-[#FFC107]">
=======
                    <div 
                      key={i} 
                      className="group flex items-start gap-3 rounded-xl p-2 transition-all duration-300 hover:bg-[#F8FAFC]"
...
=======
    ...
    {/* ============================== CTA BANNER ============================== */}
      <section className="mt-0 grid grid-cols-1 md:grid-cols-2">
>>>>>>> 1093209413a61a42d61cbb0f4b67f37f427e4c41
